...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_TITLE = "Do you love Spooky Halloween Sounds?";
    private static final String DEFAULT_TEXT_EXPLANATION = "We would be very happy if you could rate our application:) Happy Halloween!";
